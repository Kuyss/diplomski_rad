...
if (mode === "get") {
  ...
  const captureSize = captureData
                      .map(el => parseInt(el._source.layers.tls["tls.record"]["tls.record.length"]) - 48)
  ...
  console.log(JSON.stringify(sortedPageDiff, 0, 2));
  console.log("\nMost likely accessed web page is: " + sortedPageDiff[0].pageTitle);
}
